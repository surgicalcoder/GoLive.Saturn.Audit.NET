...
/// <summary>
/// Provides middleware for auditing Azure Functions executions by capturing invocation details and generating audit events
/// during function processing.
/// </summary>
/// <remarks>
/// This middleware integrates with the Azure Functions worker pipeline to record execution data, including function
/// parameters, trigger information, and exceptions. Audit events are created and stored using the
/// configured audit data provider. To customize auditing behavior, use the provided options or supply a configuration
/// delegate. The middleware should be registered in the Azure Functions worker startup to enable auditing for all function
/// invocations.
/// </remarks>
public class AuditAzureFunctionMiddleware : IFunctionsWorkerMiddleware
{
    ...
    /// </summary>
    /// <remarks>This constructor sets the Options property to a new instance of AuditAzureFunctionOptions, providing default
    /// configuration for the middleware. Use this constructor when no custom options are required.</remarks>
    ...
    /// <param name="configure">An action delegate that configures the audit options for Azure Functions. This delegate is
    /// invoked to customize auditing behavior.</param>
