...
public class AuditAzureFunctionOptions
{
    ...
    /// <summary>
    /// Gets or sets a delegate that determines whether a function definition should be included based on the specified
    /// function context.
    /// </summary>
    /// <remarks>The delegate receives a <see cref="FunctionContext" /> instance and returns whether to include the function
    /// definition, or not.</remarks>
    ...
    /// </summary>
    /// <remarks>The delegate receives a <see cref="FunctionContext" /> and returns whether to include trigger information, or
    /// not.</remarks>
