...
public static class FunctionContextExtensions
{
    ...
    /// </summary>
    /// <remarks>This method returns <see langword="null" /> if the audit event has not been set in the context. Typically, the
    /// audit event is added by the audit middleware during function invocation.</remarks>
    /// <param name="context">The function execution context from which to retrieve the audit event. Cannot be null.</param>
    /// <returns>An instance of <see cref="AuditEventAzureFunction" /> if an audit event is present in the context; otherwise,
    ...
    /// </summary>
    /// <remarks>Use this method to access audit metadata for the current function invocation, such as the function name, input
    /// parameters, and execution details. Returns <c>null</c> if no audit event is present in the context.</remarks>
    /// <param name="context">The function execution context from which to obtain the audit function call information. Cannot
    /// be null.</param>
    /// <returns>An instance of <see cref="AzureFunctionCall" /> containing details of the audit function call if available;
    ...
    /// </summary>
    /// <remarks>Use this method to access audit information for the current function execution, such as tracking changes or
    /// logging activity. The returned audit scope may be <c>null</c> if auditing is not configured for the context.</remarks>
    /// <param name="context">The function execution context from which to obtain the audit scope. Cannot be null.</param>
    /// <returns>An <see cref="IAuditScope" /> representing the audit scope for the given context, or <c>null</c> if no audit
    /// scope is available.</returns>
    ...
    /// </summary>
    /// <param name="context">The function execution context from which to obtain the Azure Function definition. Cannot be
    /// null.</param>
    /// <returns>An <see cref="AzureFunctionDefinition" /> instance containing metadata about the current Azure Function, such
    /// as its name and entry point.</returns>
    ...
    /// </summary>
    /// <param name="context">The function execution context from which to obtain the trigger binding attribute. Cannot be
    /// null.</param>
    ...
    /// <returns>An instance of <see cref="AzureFunctionTrigger" /> containing information about the function's trigger.
    /// Returns null if trigger data is unavailable.</returns>
