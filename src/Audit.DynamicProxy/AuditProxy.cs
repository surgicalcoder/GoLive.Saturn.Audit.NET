...
public class AuditProxy
{
    ...
    [field: ThreadStatic]
    public static IAuditScope CurrentScope { get; internal set; }
        ...
        where T : class
    {
        ...
        {
            auditedInstance = Generator.CreateInterfaceProxyWithTarget(instance, interceptor);
        }
        else
        {
            auditedInstance = Generator.CreateClassProxyWithTarget(instance, interceptor);
        }
