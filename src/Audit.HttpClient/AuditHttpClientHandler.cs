...
public class AuditHttpClientHandler : DelegatingHandler
{
    ...
    {
        set => _config._includeRequestBody = _ => value;
    }
    ...
    {
        set => _config._eventTypeName = _ => value;
    }
    ...
    /// creation policy.
    /// </summary>
    public EventCreationPolicy? CreationPolicy
    {
        set => _config._eventCreationPolicy = value;
    }

    /// <summary>
    /// Specifies the audit data provider to use. Default is NULL to use the globally configured data provider.
    /// </summary>
    public IAuditDataProvider AuditDataProvider
    {
        set => _config._auditDataProvider = value;
    }

    /// <summary>
    /// Specifies the Audit Scope factory to use. Default is NULL to use the default AuditScopeFactory.
    /// </summary>
    public IAuditScopeFactory AuditScopeFactory
    {
        set => _config._auditScopeFactory = value;
    }
    ...
    {
        if (scope.EventCreationPolicy == EventCreationPolicy.Manual)
        {
    ...
    private async Task<object> GetContentBody(HttpContent content, CancellationToken cancellationToken)
    {
        if (content == null)
        {
            return null;
