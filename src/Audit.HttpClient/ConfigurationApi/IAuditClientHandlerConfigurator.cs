...
public interface IAuditClientHandlerConfigurator
{
    ...
    /// </summary>
    /// <param name="includePredicate">A function of the executing context to determine whether the request body should be
    /// included on the audit output</param>
    ...
    /// </summary>
    /// <param name="includePredicate">A function of the executing context to determine whether the HTTP Content headers should
    /// be included on the audit output</param>
    ...
    /// </summary>
    /// <param name="includePredicate">A function of the executing context to determine whether the HTTP Request headers should
    /// be included on the audit output</param>
    ...
    /// </summary>
    /// <param name="includePredicate">A function of the executing context to determine whether the response body should be
    /// included on the audit output</param>
    ...
    /// </summary>
    /// <param name="includePredicate">A function of the executing context to determine whether the HTTP Response headers
    /// should be included on the audit output</param>
    ...
    /// </summary>
    /// <param name="includePredicate">A function of the option key to determine which HTTP Request Options should be included
    /// on the audit output</param>
    ...
    /// </summary>
    /// <param name="eventTypeNamePredicate">A function of the executing context to determine the event type name. The
    /// following placeholders can be used as part of the string:
