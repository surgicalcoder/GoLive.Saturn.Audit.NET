...
public class HttpAction
{
    ...
    /// </summary>
    private readonly WeakReference<HttpRequestMessage> _requestMessage = new(null);

    /// <summary>
    /// A weak reference to the HttpResponseMessage associated to this event
    /// </summary>
    private readonly WeakReference<HttpResponseMessage> _responseMessage = new(null);
    ...
    /// Returns NULL if the action is not associated to an HttpRequestMessage, or after it has been disposed of and garbage
    /// collected.
    /// </summary>
    /// <returns></returns>
    ...
    /// Returns NULL if the action failed to execute, or after the HttpResponseMessage has been disposed of and garbage
    /// collected.
    /// </summary>
    /// <returns></returns>
