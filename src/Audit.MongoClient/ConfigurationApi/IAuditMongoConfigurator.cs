...
{
    /// <summary>
    /// Specifies a predicate to determine whether the audit event should include the server reply. The reply is not included
    /// by default.
    /// </summary>
    /// <param name="includeReplyPredicate">A function of the Command Succeeded Event to determine whether to include the the
    /// server reply in the audit event</param>
    ...
    /// </summary>
    /// <param name="eventTypeNamePredicate">A function of the Command Start Event to determine the event type name. The
