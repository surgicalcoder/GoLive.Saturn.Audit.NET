...
public class MongoDataProvider : AuditDataProvider
{
    ...
    /// If <c>true</c> the element names are not validated, use this when you know the element names will not contain invalid
    /// characters.
    ...
    /// <summary>
    /// Returns an IQueryable that enables querying against the audit events stored on Azure Document DB, for the audit event
    /// type given.
    /// </summary>
