...
{
    /// <summary>
    /// Sets the NLog logger (ILogger) to use as a function of the audit event. Default is
    ...
    /// </summary>
    /// <param name="messageBuilder">A way to obtain the object to be logged. Default is the AuditEvent JSON including the
    /// EventId as a custom field.</param>
