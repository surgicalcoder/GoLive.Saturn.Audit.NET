...
/// LogLevel/LogLevelBuilder: A way to obtain the log level for the audit events. Default is Error for exceptions and Info
/// for anything else.
...
public class NLogDataProvider : AuditDataProvider
{
    ...
    public NLogDataProvider(Action<INLogConfigurator> config)
    {
        var logConfig = new NLogConfigurator();
