...
public class AuditEvent : IAuditOutput
{
    ...
    /// </summary>
    private readonly WeakReference _auditScope = new(null);
    ...
    /// Returns NULL if the Audit Event is not associated with an Audit Scope, or after the Audit Scope has been disposed of
