...
public class AuditScopeOptions
{
    ...
    /// <param name="skipExtraFrames">Used to indicate how many frames in the stack should be skipped to determine the calling
    /// method.</param>
    /// <param name="includeStackTrace">Used to indicate whether the audit event's environment should include the full stack
    /// trace.</param>
    ...
    /// <summary>
    /// Gets or sets a specific calling method to store on the event. NULL to use the calling stack to determine the calling
    /// method.
    /// </summary>
