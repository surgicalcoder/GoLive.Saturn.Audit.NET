...
public static class Configuration
{
    ...
    /// <summary>
    /// Sets the Default data provider as a factory method that will be invoked the first time it's needed and only once. This
    /// is a shortcut to set a LazyDataProvider.
    /// </summary>
    ...
    /// <summary>
    /// Gets or Sets a value that indicates if the environment information should be excluded from the audit output. Default is
    /// false to include the environment object.
    /// </summary>
    ...
    /// <summary>
    /// Global json serializer settings for serializing the audit event on the data providers or by calling the ToJson() method
    /// on the AuditEvent.
    /// </summary>
    public static JsonSerializerOptions JsonSettings { get; set; }

    // Custom actions
    internal static ConcurrentDictionary<ActionType, ConcurrentQueue<Func<AuditScope, CancellationToken, Task<bool>>>> AuditScopeActions { get; } = new();
    ...
    /// <summary>
    /// Gets the Default data provider instance as the specified type. Returns null if the data provider is not of the given
    /// type.
    /// </summary>
    /// <typeparam name="T">The IAuditDataProvider type</typeparam>
    public static T DataProviderAs<T>() where T : class, IAuditDataProvider
    {
    ...
    /// <summary>
    /// Attaches an action to be performed globally on any AuditScope. The action returns a boolean value indicating if the
    /// subsequent actions should be executed.
    /// </summary>
    /// <param name="when">To indicate when the action should be performed.</param>
    /// <param name="action">The action to perform. Return true to continue with the next actions, false to stop executing the
    /// subsequent actions.</param>
    ...
    /// <summary>
    /// Attaches an asynchronous action to be performed globally on any AuditScope. The action returns a boolean value
    /// indicating if the subsequent actions should be executed.
    /// </summary>
    /// <param name="when">To indicate when the action should be performed.</param>
    /// <param name="asyncAction">The asynchronous action to perform. Return true to continue with the next actions, false to
    /// stop executing the subsequent actions.</param>
    ...
    /// <summary>
    /// Attaches a global action to be performed on the audit scope before the audit event is saved. The action returns a
    /// boolean value indicating if the subsequent actions should be executed.
    /// </summary>
    /// <param name="action">The action to perform. Return true to continue with the next actions, false to stop executing the
    /// subsequent actions.</param>
    ...
    /// <summary>
    /// Attaches a global asynchronous action to be performed on the audit scope before the audit event is saved. The action
    /// returns a boolean value indicating if the subsequent actions should be executed.
    /// </summary>
    /// <param name="asyncAction">The asynchronous action to perform. Return true to continue with the next actions, false to
    /// stop executing the subsequent actions.</param>
    ...
    /// <summary>
    /// Attaches a global action to be performed on the audit scope right after it is created and before any saving. The action
    /// returns a boolean value indicating if the subsequent actions should be executed.
    /// </summary>
    /// <param name="action">The action to perform. Return true to continue with the next actions, false to stop executing the
    /// subsequent actions.</param>
    ...
    /// <summary>
    /// Attaches a global asynchronous action to be performed on the audit scope right after it is created and before any
    /// saving.
    /// </summary>
    /// <param name="asyncAction">The asynchronous action to perform.</param>
    ...
    /// <summary>
    /// Attaches a global asynchronous action to be performed on the audit scope right after it is created and before any
    /// saving. The action returns a boolean value indicating if the subsequent actions should be executed.
    /// </summary>
    /// <param name="asyncAction">The asynchronous action to perform. Return true to continue with the next actions, false to
    /// stop executing the subsequent actions.</param>
    ...
    /// <summary>
    /// Attaches a global action to be performed on the audit scope right after it is disposed. The action returns a boolean
    /// value indicating if the subsequent actions should be executed.
    /// </summary>
    /// <param name="action">The action to perform. Return true to continue with the next actions, false to stop executing the
    /// subsequent actions.</param>
