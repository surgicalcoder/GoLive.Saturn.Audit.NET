...
public static class Configuration
{
    ...
    public static T DataProviderAs<T>() where T : AuditDataProvider
    {
    ...
    public static void AddCustomAction(ActionType when, Func<AuditScope, Task> asyncAction)
    {
        lock (Locker)
        {
            AuditScopeActions[when].Add(async (scope, _) => { await asyncAction.Invoke(scope); });
        }
    }
    ...
    public static void AddCustomAction(ActionType when, Func<AuditScope, CancellationToken, Task> asyncAction)
    {
        lock (Locker)
        {
            AuditScopeActions[when].Add(async (scope, ct) => { await asyncAction.Invoke(scope, ct); });
        }
    }
    ...
    public static void AddOnSavingAction(Func<AuditScope, Task> asyncAction)
    {
        lock (Locker)
        {
            AuditScopeActions[ActionType.OnEventSaving].Add(async (scope, _) => { await asyncAction.Invoke(scope); });
        }
    }
    ...
    public static void AddOnSavingAction(Func<AuditScope, CancellationToken, Task> asyncAction)
    {
        lock (Locker)
        {
            AuditScopeActions[ActionType.OnEventSaving].Add(async (scope, ct) => { await asyncAction.Invoke(scope, ct); });
        }
    }
    ...
    public static void AddOnCreatedAction(Func<AuditScope, Task> asyncAction)
    {
        lock (Locker)
        {
            AuditScopeActions[ActionType.OnScopeCreated].Add(async (scope, _) => { await asyncAction.Invoke(scope); });
        }
    }
    ...
    public static void AddOnCreatedAction(Func<AuditScope, CancellationToken, Task> asyncAction)
    {
        lock (Locker)
        {
            AuditScopeActions[ActionType.OnScopeCreated].Add(async (scope, ct) => { await asyncAction.Invoke(scope, ct); });
        }
    }
    ...
    public static void AddOnDisposedAction(Func<AuditScope, Task> asyncAction)
    {
        lock (Locker)
        {
            AuditScopeActions[ActionType.OnScopeDisposed].Add(async (scope, _) => { await asyncAction.Invoke(scope); });
        }
    }
    ...
    public static void AddOnDisposedAction(Func<AuditScope, CancellationToken, Task> asyncAction)
    {
        lock (Locker)
        {
            AuditScopeActions[ActionType.OnScopeDisposed].Add(async (scope, ct) => { await asyncAction.Invoke(scope, ct); });
        }
    }
