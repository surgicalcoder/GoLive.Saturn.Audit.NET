...
public interface IDynamicAsyncDataProviderConfigurator
{
    ...
    /// <summary>
    /// Attaches an asynchronous action to be executed by the InsertEvent method that will return a random Guid as the event
    /// id.
    /// </summary>
    ...
    /// <summary>
    /// Attaches an asynchronous action to be executed by the InsertEvent and the ReplaceEvent methods, the first parameter
    /// (event id) will be NULL in case of insert.
    /// The InsertEvent will generate and return a random Guid as the event id.
    /// </summary>
    /// <param name="insertReplaceAction">The action to be executed by the InsertEvent and the ReplaceEvent methods.</param>
