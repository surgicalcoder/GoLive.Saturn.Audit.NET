...
/// <remarks>
/// Settings:
/// - DirectoryPathBuilder: A function that returns the file system path to store the output for an event. If this setting
/// is provided, DirectoryPath setting will be ignored.
/// - DirectoryPath: Directory path to store the output files (default is current directory). This setting is ignored when
/// using DirectoryPathBuilder.
...
public class FileDataProvider : AuditDataProvider
{
    ...
    public FileDataProvider(Action<IFileLogProviderConfigurator> config)
    {
        var fileConfig = new FileLogProviderConfigurator();
        ...
        public static long UtcNowTicks
        {
            get
            {
                ...
                do
                {
                    ...
                    var now = Configuration.SystemClock.GetCurrentDateTime().Ticks;
