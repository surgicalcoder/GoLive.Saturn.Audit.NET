...
/// <summary>
/// A deferred data provider that allows to defer the data provider creation until the audit event is about to be saved.
/// The data provider factory method will be called for each audit event being saved.
/// </summary>
